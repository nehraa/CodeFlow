...
const TS_JS_QUERIES: LanguageQueries = {
  functions: `
...
const PYTHON_QUERIES: LanguageQueries = {
  functions: `
    (function_definition
      name: (identifier) @name
...
const C_QUERIES: LanguageQueries = {
  functions: `
    (function_definition
...
const CPP_QUERIES: LanguageQueries = {
  functions: `
    (function_definition
      declarator: (function_declarator
        declarator: (identifier) @name
...
export const QUERIES_BY_LANGUAGE: Record<SupportedLanguage, LanguageQueries> = {
