...
const getStubContent = (node: BlueprintNode): string => {
...
export const writeBlueprintGraphToWorkspace = async (
  ...
  await writeJsonFile(
    path.join(workspaceDir, "src", "graph-meta.json"),
    {
...
export const compileTypeScriptWorkspace = async (
  workspaceDir: string
