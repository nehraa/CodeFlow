 ...
 */
const sanitizeFlowchartLabel = (label) => label
    .replace(/[\r\n]/g, " ")
    .replace(/;/g, "#59;")
    .replace(/`/g, "#96;")
    .replace(/</g, "#lt;")
 ...
 */
const sanitizeClassLabel = (label) => label
    .replace(/[\r\n]/g, " ")
    .replace(/;/g, "#59;")
    .replace(/\\/g, "\\\\")
    .replace(/"/g, "#quot;")
...
export const toMermaidClassDiagram = (graph) => {
    const relevantKinds = new Set(["class", "function"]);
