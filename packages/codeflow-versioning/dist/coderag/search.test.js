...
const makeBranch = (id, name, graphNodes, graphEdges, parentBranchId) => ({
    id,
    name,
    projectName: "test-project",
...
describe("search.ts", () => {
    describe("formatStructuralDiff", () => {
                ...
                nodeDiffs: [
                    {
                        ...
                        name: "AddedNode",
                        kind: "added",
                        after: { id: "node-1", name: "AddedNode", kind: "function", summary: "", path: undefined, ownerId: undefined, signature: undefined, contract: makeContract(), status: "spec_only", sourceRefs: [], generatedRefs: [], traceRefs: [] },
                        impactedEdgeCount: 1
                    },
                    {
                        nodeId: "node-2",
                        name: "RemovedNode",
                        kind: "removed",
                        before: { id: "node-2", name: "RemovedNode", kind: "function", summary: "", path: undefined, ownerId: undefined, signature: undefined, contract: makeContract(), status: "spec_only", sourceRefs: [], generatedRefs: [], traceRefs: [] },
                        impactedEdgeCount: 2
                    },
                    {
                        nodeId: "node-3",
                        name: "ModifiedNode",
                        kind: "modified",
                        before: { id: "node-3", name: "ModifiedNode", kind: "function", summary: "Before summary", path: undefined, ownerId: undefined, signature: undefined, contract: makeContract(), status: "spec_only", sourceRefs: [], generatedRefs: [], traceRefs: [] },
                        after: { id: "node-3", name: "ModifiedNode", kind: "function", summary: "After summary", path: undefined, ownerId: undefined, signature: undefined, contract: makeContract(), status: "spec_only", sourceRefs: [], generatedRefs: [], traceRefs: [] },
                        impactedEdgeCount: 0
                    }
                ],
                edgeDiffs: [
                    { from: "a", to: "b", edgeKind: "calls", diffKind: "added" },
                    { from: "b", to: "c", edgeKind: "calls", diffKind: "removed" },
                    { from: "c", to: "d", edgeKind: "calls", diffKind: "unchanged" }
                ]
            };
                ...
                nodeDiffs: [
                    {
                        ...
                        name: "TestNode",
                        kind: "added",
                        after: { id: "n1", name: "TestNode", kind: "function", summary: "", path: undefined, ownerId: undefined, signature: undefined, contract: makeContract(), status: "spec_only", sourceRefs: [], generatedRefs: [], traceRefs: [] },
                        impactedEdgeCount: 0
                    }
                ],
                edgeDiffs: [
        ...
        it("should filter to edges only when focusOn is edges", () => {
            const diff = {
                ...
                nodeDiffs: [],
                edgeDiffs: [
                    { from: "x", to: "y", edgeKind: "calls", diffKind: "added" }
                ]
            };
    ...
    describe("searchBranches", () => {
        ...
        it("should return empty array when query returns no answer", async () => {
            ...
            const { getCodeRagInstance } = await import("./index.js");
            vi.mocked(getCodeRagInstance).mockReturnValue(mockCodeRag);
            const result = await searchBranches({
                projectName: "test-project",
                query: "test query"
            });
