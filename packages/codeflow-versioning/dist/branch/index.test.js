...
describe("diffBranches", () => {
    it("returns unchanged diff for identical graphs", () => {
        const graph = makeGraph([{ id: "n1", kind: "function", name: "foo", summary: "Does a thing" }], [{ from: "n1", to: "n2", kind: "calls" }]);
    ...
    it("detects added edges", () => {
        ...
        const newEdgeDiff = diff.edgeDiffs.find((e) => e.from === "n2" && e.to === "n3" && e.diffKind === "added");
    ...
    it("detects removed edges", () => {
        ...
        const removedEdgeDiff = diff.edgeDiffs.find((e) => e.from === "n2" && e.to === "n3" && e.diffKind === "removed");
