 ...
 */
async function requestNvidiaChatCompletion({ apiKey, messages, model, temperature, maxTokens, }) {
 ...
 */
function normalizeAiBlueprint(parsed, options) {
    const nodes = [];
    const edges = [];
