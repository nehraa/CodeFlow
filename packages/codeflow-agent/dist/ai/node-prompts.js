 ...
 */
export function buildNodePrompt(options) {
 ...
 */
export function estimateNodeRisk(node) {
    ...
    const hasStateModification = node.contract.sideEffects.some((se) => se.toLowerCase().includes('write') || se.toLowerCase().includes('delete'));
 ...
 */
export function buildAllNodePrompts(graph) {
