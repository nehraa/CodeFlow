...
describe("approval", () => {
    ...
    describe("createApprovalRecord", () => {
        ...
        it("writes the record to disk at the correct path", async () => {
            await withEnv(async () => {
                ...
                const filePath = path.join(STORE_ROOT, "approvals", `${record.id}.json`);
    ...
    describe("approveRecord", () => {
        it("throws when the record does not exist", async () => {
            await withEnv(async () => {
                await expect(approveRecord("does-not-exist", "test-approver")).rejects.toThrow("Approval does-not-exist was not found.");
            });
        });
