...
describe("branch module — BRUTAL edge case tests", () => {
  ...
  const makeBranch = (overrides: Partial<GraphBranch> = {}): GraphBranch => ({
    id: "branch-1",
    name: "branch-1",
  ...
  describe("saveBranch", () => {
    ...
    it("null — exact error message", async () => {
      let thrown: any;
      try { await saveBranch(null as any); } catch (e: any) { thrown = e; }
    ...
    it("undefined — exact error message", async () => {
      let thrown: any;
      try { await saveBranch(undefined as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/saveBranch: branch is required/);
    });
    ...
    it("empty object {} — exact error mentions all missing fields", async () => {
      let thrown: any;
      try { await saveBranch({} as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
    ...
    it("wrong type string — exact error", async () => {
      let thrown: any;
      try { await saveBranch("not-an-object" as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
    ...
    it("wrong type number — exact error", async () => {
      let thrown: any;
      try { await saveBranch(42 as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch is required/);
    });
    ...
    it("only projectId+branchName (no id/name/projectName) — error mentions id requirement", async () => {
      let thrown: any;
      try {
        await saveBranch({ projectId: "p", branchName: "b" } as any);
    ...
    it("{ projectId, branchName } — works via normalization, name=branchName, projectName=projectId", async () => {
      const result = await saveBranch({ id: "bid", projectId: "my-proj", branchName: "my-branch" } as any);
    ...
    it("{ id, projectId } — throws; name missing and no branchName fallback", async () => {
      let thrown: any;
      try { await saveBranch({ id: "bid", projectId: "proj-x" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
    ...
    it("{ id, branchName } — throws; projectName missing and no projectId fallback", async () => {
      let thrown: any;
      try { await saveBranch({ id: "bid", branchName: "branch-x" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
    ...
    it("id missing entirely — error mentions branch.id clearly", async () => {
      let thrown: any;
      try {
        await saveBranch({ name: "b", projectName: "p" } as any);
      } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch.id is required/);
    ...
    it("id = empty string — error", async () => {
      let thrown: any;
      try { await saveBranch({ id: "", name: "b", projectName: "p" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch.id is required/);
    });
    ...
    it("name missing entirely — error mentions name requirement", async () => {
      let thrown: any;
      try { await saveBranch({ id: "bid", projectName: "p" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch.name is required/);
    });
    ...
    it("name = empty string — error", async () => {
      let thrown: any;
      try { await saveBranch({ id: "bid", name: "", projectName: "p" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch.name is required/);
    });
    ...
    it("projectName missing entirely — error mentions projectName", async () => {
      let thrown: any;
      try { await saveBranch({ id: "bid", name: "b" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch.projectName is required/);
    });
    ...
    it("projectName = empty string — error", async () => {
      let thrown: any;
      try { await saveBranch({ id: "bid", name: "b", projectName: "" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch.projectName is required/);
    });
    ...
    it("projectId + branchName but wrong id type — error on id", async () => {
      let thrown: any;
      try { await saveBranch({ id: 123 as any, projectId: "p", branchName: "b" } as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branch.id is required/);
    });
  ...
  describe("loadBranch", () => {
    ...
    it("null projectName — exact error", async () => {
      let thrown: any;
      try { await loadBranch(null as any, "some-branch"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
    ...
    it("null branchId — exact error", async () => {
      let thrown: any;
      try { await loadBranch("some-project", null as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
    ...
    it("undefined projectName — exact error", async () => {
      let thrown: any;
      try { await loadBranch(undefined as any, "some-branch"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("undefined branchId — exact error", async () => {
      let thrown: any;
      try { await loadBranch("some-project", undefined as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branchId must be a non-empty string/);
    });
    ...
    it("empty string projectName — exact error", async () => {
      let thrown: any;
      try { await loadBranch("", "some-branch"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("empty string branchId — exact error", async () => {
      let thrown: any;
      try { await loadBranch("some-project", ""); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branchId must be a non-empty string/);
    });
    ...
    it("whitespace-only projectName — error", async () => {
      let thrown: any;
      try { await loadBranch("   ", "branch"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("number projectName — error", async () => {
      let thrown: any;
      try { await loadBranch(42 as any, "branch"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("number branchId — error", async () => {
      let thrown: any;
      try { await loadBranch("proj", 99 as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branchId must be a non-empty string/);
    });
  });
  ...
  describe("loadBranches", () => {
    ...
    it("null projectName — exact error (not toLowerCase crash)", async () => {
      let thrown: any;
      try { await loadBranches(null as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
      expect(thrown.message).toMatch(/null/);
    });
    ...
    it("undefined projectName — exact error", async () => {
      let thrown: any;
      try { await loadBranches(undefined as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("empty string projectName — error", async () => {
      let thrown: any;
      try { await loadBranches(""); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("number projectName — error", async () => {
      let thrown: any;
      try { await loadBranches(99 as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
  ...
  describe("deleteBranch", () => {
    ...
    it("null projectName — throws exact error", async () => {
      let thrown: any;
      try { await deleteBranch(null as any, "branch-x"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("null branchId — throws exact error", async () => {
      let thrown: any;
      try { await deleteBranch("proj-x", null as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branchId must be a non-empty string/);
    });
    ...
    it("undefined projectName — throws exact error", async () => {
      let thrown: any;
      try { await deleteBranch(undefined as any, "branch-x"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("undefined branchId — throws exact error", async () => {
      let thrown: any;
      try { await deleteBranch("proj-x", undefined as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branchId must be a non-empty string/);
    });
    ...
    it("empty string projectName — throws error", async () => {
      let thrown: any;
      try { await deleteBranch("", "branch-x"); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
    ...
    it("empty string branchId — throws error", async () => {
      let thrown: any;
      try { await deleteBranch("proj-x", ""); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/branchId must be a non-empty string/);
    });
    ...
    it("null projectName + null branchId — throws on projectName first", async () => {
      let thrown: any;
      try { await deleteBranch(null as any, null as any); } catch (e: any) { thrown = e; }
      expect(thrown).toBeDefined();
      expect(thrown.message).toMatch(/projectName must be a non-empty string/);
    });
