...
import { buildSimulationSpans, buildUserFlows, computeDigitalTwinSnapshot, overlayActiveNodes } from "./digital-twin.js";
import { emptyContract } from "./types.js";
// ── Fixtures ───────────────────────────────────────────────────────────────
const makeGraph = () => ({
    projectName: "TestApp",
    mode: "essential",
    ...
    it("groups spans by traceId into flows", () => {
        ...
        const spans = [
            ...
            makeSpan({
                ...
                traceId: "t2",
                name: "checkout",
                blueprintNodeId: "function:checkout",
...
describe("buildSimulationSpans", () => {
    it("creates one span per node in order", () => {
        const graph = makeGraph();
        const spans = buildSimulationSpans(graph, [
            "function:auth",
            "api:products",
            "function:checkout"
        ]);
...
//# sourceMappingURL=digital-twin.test.js.map